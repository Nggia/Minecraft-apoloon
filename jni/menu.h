		 ...
		 if (ImGui::Begin(OBFUSCATE("Description"), NULL, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove)) {
			 ...
			 if (ImGui::BeginTabBar(OBFUSCATE("Tab"))) {
				...
				if (ImGui::BeginTabItem(OBFUSCATE("English"))) {
					 ...
					 ImGui::SetWindowFontScale(1.0);
					 ImGui::Separator();
				     ImGui::Text("%s", OBFUSCATE("Update 4.6:"));
					 ImGui::Text("%s", OBFUSCATE("\n- Updated Xray."));
					 ImGui::Text("%s", OBFUSCATE("\n- Improved Anti Bot."));
	 ...
	 if (ImGui::Begin(OBFUSCATE("The Apollon Client v4.62 | APK (x86_64 Bit) | Minecraft v1.21.111"), NULL, ImGuiWindowFlags_NoResize)) {
        ...
        switch (pageId) {
			case 0:
				...
				if (ImGui::BeginTabBar(OBFUSCATE("Movements"))) {
					...
					if (ImGui::BeginTabItem(OBFUSCATE("Other"))) {
						...
						ImGui::Text("%s", OBFUSCATE("Bedrock Core Predicition Anti Cheat"));
			...
			case 1:
				if (ImGui::BeginTabBar(OBFUSCATE("Tab1"))) {
					if (ImGui::BeginTabItem(OBFUSCATE("Players"))) {
						...
						ImGui::PushItemWidth(0);
				        DrawSeparatorToWindowEdge(endVertical, 16.0f);
				        ImGui::Text("%s", OBFUSCATE("Aura Settings"));
				        ImGui::PushItemWidth(calcResX * 200);
						...
						if (ImGui::BeginTabBar(OBFUSCATE("TabMobs"))) {
					    	...
					    	if (ImGui::BeginTabItem(OBFUSCATE("Main"))) {
						     ...
						     if (ImGui::BeginTabItem(OBFUSCATE("Mob List"))) {
								ImGui::Text("%s", OBFUSCATE("List of mobs that MobAura DOES NOT ATTACK"));
			...
			case 5:
				...
				ImGui::PushItemWidth(calcResX * 300);
				ImGui::Text("%s", OBFUSCATE("Replace Android Buttons:"));
				...
				ImGui::Separator();
				ImGui::Text("%s", OBFUSCATE("Replace Physical Keyboard Buttons:"));
			...
			case 6:
				...
				if (ImGui::BeginTabItem(OBFUSCATE("Config"))) {
					ImGui::Text("%s", OBFUSCATE("Config Load/Save Path: /sdcard/Download/Apollon.json")); 
            ...
            case 7:
				...
				ImGui::Text("%s", OBFUSCATE("Thanks MCPELIFE for a decent pairip bypass :)"));
                DrawSeparatorToWindowEdge(endVertical, 16.0f);
                ImGui::Text("%s", OBFUSCATE("Mod Version: v4.62")); 
                ImGui::Text("%s", OBFUSCATE("Game Version: 1.21.111"));
                #if defined(__aarch64__)
                ImGui::Text("%s", OBFUSCATE("Bit: 64")); 
                #elif defined(__ARM_ARCH_7A__)
                ImGui::Text("%s", OBFUSCATE("Bit: 32"));
				#else
				ImGui::Text("%s", OBFUSCATE("Bit: 86_64"));
                #endif
                DrawSeparatorToWindowEdge(endVertical, 16.0f);
				float imageSize = ImGui::GetFontSize();
				ImGui::Image((ImTextureID)(intptr_t)youtube_icon, ImVec2(imageSize, imageSize));
				...
				ImGui::Text("%s", OBFUSCATE(": https://discord.gg/RSC4ZrVjS8"));
                DrawSeparatorToWindowEdge(endVertical, 16.0f);
                ImGui::Text("%s", OBFUSCATE("Made By ZEFF"));
                break;
        }
        ImGui::EndGroup();
